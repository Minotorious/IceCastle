...
iceCastle:registerAssetId("models/iceCastleMonument.fbx/Prefab/crenellationSpikesPart", "PREFAB_CRENELLATION_SPIKES_PART")
iceCastle:registerAssetId("models/iceCastleMonument.fbx/Prefab/wallSpikesPart", "PREFAB_WALL_SPIKES_PART")

function registerScalablePrefabBuildingParts(_nodePrefix)
	iceCastle:registerAssetId("models/iceCastleMonument.fbx/Prefab/" .. _nodePrefix[1] .. ".Root", "PREFAB_" ..  _nodePrefix[2] .. "_ROOT_PART")
	iceCastle:registerAssetId("models/iceCastleMonument.fbx/Prefab/" .. _nodePrefix[1] .. ".Filler1", "PREFAB_" ..  _nodePrefix[2] .. "_FILLER1_PART")
	iceCastle:registerAssetId("models/iceCastleMonument.fbx/Prefab/" .. _nodePrefix[1] .. ".Filler2", "PREFAB_" ..  _nodePrefix[2] .. "_FILLER2_PART")
	iceCastle:registerAssetId("models/iceCastleMonument.fbx/Prefab/" .. _nodePrefix[1] .. ".Filler3", "PREFAB_" ..  _nodePrefix[2] .. "_FILLER3_PART")
	iceCastle:registerAssetId("models/iceCastleMonument.fbx/Prefab/" .. _nodePrefix[1] .. ".Filler4", "PREFAB_" ..  _nodePrefix[2] .. "_FILLER4_PART")
	iceCastle:registerAssetId("models/iceCastleMonument.fbx/Prefab/" .. _nodePrefix[1] .. ".End", "PREFAB_" ..  _nodePrefix[2] .. "_END_PART")
end
...
iceCastle:registerAssetId("models/iceCastleMonument.fbx/Materials/Material.StonebrickBlueIce", "MATERIAL_STONEBRICK_BLUE_ICE")
iceCastle:registerAssetId("models/iceCastleMonument.fbx/Materials/Material.CrystalBlue", "MATERIAL_CRYSTAL_BLUE")
iceCastle:registerAssetId("models/iceCastleMonument.fbx/Materials/Material.BlueIceTransparent", "MATERIAL_BLUE_ICE_TRANSPARENT")
iceCastle:registerAssetId("models/iceCastleMonument.fbx/Materials/Material.MetalIceTransparent", "MATERIAL_METAL_ICE_TRANSPARENT")
...
iceCastle:registerAssetProcessor("models/iceCastleMonument.fbx", { DataType = "BUILDING_ASSET_PROCESSOR" })

iceCastle:registerPrefabComponent("models/iceCastleMonument.fbx/Prefab/crenellationSpikesPart", { DataType = "COMP_BUILDING_PART", BuildingPartType = "MINOR" })
iceCastle:registerPrefabComponent("models/iceCastleMonument.fbx/Prefab/wallSpikesPart", { DataType = "COMP_BUILDING_PART", BuildingPartType = "MINOR" })
